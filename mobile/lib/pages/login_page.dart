...
import 'package:scialla/appwrite/auth_api.dart';
import 'package:scialla/pages/messages_page.dart';
import 'package:scialla/pages/register_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Scialla App', style: TextStyle(color: Colors.white) ),
